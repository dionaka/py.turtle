...
while True:
    ...
    if mode != '5' and mode != '7':
        ...
        def draw_contours(contours, original_color_img, total_contours):
            import sys
            import time
        ...
        if mode == '1':
            ...
            draw_contours(contours, img_color_resized, len(contours)) # Pass the *resized* color image to the drawing function
